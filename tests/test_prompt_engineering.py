...
from agentic_spec.prompt_engineering import PromptEngineer, create_default_context_parameters
...
class TestPromptEngineer:
    ...
    def test_build_context_aware_prompt_with_empty_context(self):
        ...
        result = self.prompt_engineer.build_context_aware_prompt(self.base_prompt, context_params)
        assert result == self.base_prompt
    ...
    def test_analyze_feedback_history_with_data(self):
        ...
        feedback_data = [
            FeedbackData(rating=4, accuracy_score=5, relevance_score=3, comments="Good overall"),
            FeedbackData(rating=3, accuracy_score=4, relevance_score=4, comments="Could be more specific"),
            FeedbackData(rating=5, accuracy_score=5, relevance_score=5, comments="Excellent detail")
        ]
        ...
        assert len(analysis["improvement_areas"]) >= 0  # May or may not have improvement areas
